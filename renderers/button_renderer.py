...
## 修复说明 (2026-04-02)
【问题】canvas.py 中的 ComponentGraphicsItem._paint_button 方法包含按钮绘制逻辑。

【解决方案】将按钮绘制逻辑抽取到 ButtonRenderer 类中。

【原代码位置】canvas.py 中对应的绘制方法
"""
...
class ButtonRenderer(ComponentRenderer):
    ...
    ## 修复说明 (2026-04-02)
    从 ComponentGraphicsItem 中抽取按钮绘制逻辑。
    """
