...
for mod in ['models', 'views', 'controllers', 'runtime', 'renderers', 'services', 'utils', 'dev_mode', 'styles', 'eventbus', 'presenters', 'templates']:
    sys.path.insert(0, os.path.join(base_dir, mod))

output_dir = os.path.join(base_dir, 'packaging', 'output', 'test_export2')

entry_script = os.path.join(output_dir, 'main.py')
