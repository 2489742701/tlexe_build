...
class MainWindow(QMainWindow):
    ...
    unbind_extension_requested = Signal(str, str, str)  # 解除组件延伸绑定，参数：comp_id, target_id, action_type
    ...
    def _init_ui(self):
        ...
        self.property_panel.unbind_extension_requested.connect(self.unbind_extension_requested.emit)
    ...
    def _init_menubar(self):
        ...
        export_exe_action = QAction("导出为可执行文件(&X)...", self)
        export_exe_action.triggered.connect(self.export_to_exe.emit)
        file_menu.addAction(export_exe_action)
        ...
        export_exe_tool_action = QAction("导出为 EXE(&X)...", self)
        export_exe_tool_action.triggered.connect(self.export_to_exe.emit)
        tools_menu.addAction(export_exe_tool_action)
    ...
    def show_warning(self, title: str, message: str):
        ...
        WarningDialog.show_warning(self, title, message)
